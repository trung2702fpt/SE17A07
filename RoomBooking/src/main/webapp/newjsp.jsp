...
<html>
    ...
    <link href="include/asset/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
    ...
    <body>
        ...
        <div id="page-top">
            ...
            <script src="inlcude/asset/vendor/jquery/jquery.min.js"></script>
            <script src="inlcude/asset/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

            <!-- Core plugin JavaScript-->
            <script src="inlcude/asset/vendor/jquery-easing/jquery.easing.min.js"></script>

            <!-- Custom scripts for all pages-->
            <script src="inlcude/asset/js/sb-admin-2.min.js"></script>

            <!-- Page level plugins -->
            <script src="inlcude/asset/vendor/chart.js/Chart.min.js"></script>

            <!-- Page level custom scripts -->
            <script src="inlcude/asset/js/demo/chart-area-demo.js"></script>
            <script src="inlcude/asset/js/demo/chart-pie-demo.js"></script>
